...
export const insertLoginUserSchema = createInsertSchema(user, loginRefineOptionsd)

const insertUserSchema = createInsertSchema(user, registerRefineOptions)
export const userRegisterAuthSchema = z.intersection(insertUserSchema, userRegisterConfirmPassword)
