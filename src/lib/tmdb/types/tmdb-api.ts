...
export const personImagesSchema = z.object({
  profiles: z.array(moviePosterSchema),
})
...
// use this type to get zod type

export const personCastSchema = z.object({
  adult: z.boolean(),
  backdrop_path: z.union([z.string().optional(), z.null()]),
...
export const presonMovieCreditsSchema = z.object({
  cast: z.array(personCastSchema),
})
...
export const personSchema = z.object({
  ...
  deathday: z.union([z.string().optional(), z.null()]),
  gender: z.number().optional(),
