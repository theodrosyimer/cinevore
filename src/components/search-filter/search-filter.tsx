            ...
            >
              {yearFilters.map((filter) => (
                <MenubarRadioItem
                  ...
                  onSelect={() => {
                    router.push(
                      `/search/films?${createQueryString('year', filter.title)}`,
                    )
                  }}
                >
            ...
            >
              {ratingFilters.map((filter) => (
                <MenubarRadioItem
                  ...
                  onSelect={() => {
                    router.push(
                      `/search/films?${createQueryString('rating', filter.title)}`,
                    )
                  }}
                >
                  <MenubarItemIndicator className="MenubarItemIndicator"></MenubarItemIndicator>
            ...
            >
              {popularFilters.map((filter) => (
                <MenubarRadioItem
                  ...
                  onSelect={() => {
                    router.push(
                      `/search/films?${createQueryString('popular', filter.title)}`,
                    )
                  }}
                >
                  <MenubarItemIndicator className="MenubarItemIndicator"></MenubarItemIndicator>
            ...
            >
              {genreFilters.map((filter) => (
                <MenubarRadioItem
                  ...
                  onSelect={() => {
                    router.push(
                      `/search/films?${createQueryString('genre', filter.title)}`,
                    )
                  }}
                >
                  <MenubarItemIndicator className="MenubarItemIndicator"></MenubarItemIndicator>
            ...
            >
              {serviceFilters.map((filter) => (
                <MenubarRadioItem
                  ...
                  onSelect={() => {
                    router.push(
                      `/search/films?${createQueryString('service', filter.title)}`,
                    )
                  }}
                >
                  <MenubarItemIndicator className="MenubarItemIndicator"></MenubarItemIndicator>
