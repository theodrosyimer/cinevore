  ...
  return (
    <>
      <div className="grid  gap-12">
        ...
        <section>
          <h2 id='features' className='text-md text-muted-foreground uppercase mb-2 scroll-mt-20'>Cinevore lets you</h2>
        ...
        <section>
          <h2 className='text-md text-muted-foreground uppercase mb-2'>Just reviewed...</h2>
          <div className="grid gap-4 grid-cols-12">
            <FilmCardList limit={12} aspectRatio='portrait'
        ...
        <section>
          ...
          <p className='text-center'>
            Below are some popular reviews and lists from this week. Sign up to create your own.</p>
        </section>
        ...
        <div className="grid gap-20 lg:grid-cols-3">
          <section className='lg:col-span-2 lg:row-span-2'>
            <div className="flex items-center justify-items-center justify-between">
              <h2 className='text-md text-muted-foreground uppercase mb-2'>Popular reviews this week</h2>
              <Link
                href={`${process.env.NEXT_PUBLIC_APP_URL}/reviews?sortBy=popular`}
                className={cn('text-sm uppercase', buttonVariants({ variant: 'link', className: 'text-muted-foreground/50 pr-0' }))}>
                More
              </Link>
            </div>
          ...
          <section className=''>
            <div className="flex items-end justify-items-center justify-between">
              <h2 className='text-md text-muted-foreground uppercase mb-2'>Popular lists</h2>
              <Link
          ...
          <section className=''>
            <div className="flex items-center justify-items-center justify-between">
              <h2 className='text-md text-muted-foreground uppercase mb-2'>Popular reviewers</h2>
              <Link
