...
export const defaultFollowers = [
  {
    userId: defaultUsers[0]?.id ?? '',
    following: defaultUsers[1]?.id ?? '',
  },
  {
    userId: defaultUsers[0]?.id ?? '',
    following: defaultUsers[2]?.id ?? '',
  },
  {
    userId: defaultUsers[0]?.id ?? '',
    following: defaultUsers[3]?.id ?? '',
  },
  {
    userId: defaultUsers[0]?.id ?? '',
    following: defaultUsers[4]?.id ?? '',
  },
  {
    userId: defaultUsers[0]?.id ?? '',
    following: defaultUsers[5]?.id ?? '',
  },
  {
    userId: defaultUsers[1]?.id ?? '',
    following: defaultUsers[0]?.id ?? '',
  },
  {
    userId: defaultUsers[1]?.id ?? '',
    following: defaultUsers[2]?.id ?? '',
